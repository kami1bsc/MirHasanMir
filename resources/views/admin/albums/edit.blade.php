        ...
        <div class="col-md-6">
            <form action="{{ route('admin.albums.update', $album->id) }}" method = "POST" enctype = "multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name = "released_year" value = "{{ $album->released_year }}" class = "form-control" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group text-center mt-3">
                    <input type="submit" name = "submit" class = "btn btn-md form-control btn-primary" value = "Update Album">
                </div>
            </form>
        </div>
        <div class="col-md-3"></div>
